...
void showSurahListSheet({
  ...
  required void Function(int surahId, int page) onSurahSelected,
}) {
...
void showJuzListSheet({
  ...
  required QuranDatabaseHelper db,
  required void Function(int surah, int ayah, int page) onJuzSelected,
}) {
  showModalBottomSheet(
    context: context,
    backgroundColor: Colors.transparent,
